...
const de_simple: UIStrings = {
  app_name: 'easli',
  app_tagline: 'Verstehe Briefe, einfach und ruhig.',
  continue: 'Weiter',
  back: 'Zurück',
  next: 'Weiter',
  skip: 'Überspringen',
  ...
  onb1_body: 'easli liest Briefe. easli erklärt sie ruhig und klar.',
  onb2_title: 'Fristen und Schritte sehen',
  onb2_body: 'Du siehst: Was steht im Brief? Was kannst du als Nächstes tun?',
  onb3_title: 'Deine Daten sind sicher',
  onb3_body: 'Die KI-Analyse macht Mistral AI. Das ist eine europäische Firma aus Paris (Frankreich). Mistral speichert Daten standardmäßig in der EU. Wir speichern keine Originale. Keine Werbung. Kein Tracking. Du kannst alles jederzeit löschen.',
  onb_get_started: 'Los geht es',
  onb_pick_lang_title: 'Wähle deine Sprache',
  onb_demo_subtitle: 'Scanne einen Brief. Erhalte eine klare Erklärung in deiner Sprache.',
  onb_large_font: 'Größere Schrift (besser lesbar)',
