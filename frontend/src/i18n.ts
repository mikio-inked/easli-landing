...
const de_simple: UIStrings = {
  app_name: 'easli',
  app_tagline: 'Verstehen Sie Briefe — einfach und ruhig.',
  continue: 'Weiter',
  back: 'Zurück',
  next: 'Weiter',
  skip: 'Überspringen',
  ...
  home_intro: 'Machen Sie ein Foto von einem Brief. Oder laden Sie einen Brief hoch. easli erklärt: Was steht im Brief? Was sollten Sie tun?',
  ...
  support: 'Hilfe',
  analyzing_title: 'easli liest Ihren Brief',
  ...
  onb3_body: 'Die KI-Analyse macht Mistral AI. Das ist eine europäische Firma aus Paris (Frankreich). Mistral speichert Daten standardmäßig in der EU. Wir speichern keine Originale. Keine Werbung. Kein Tracking. Sie können alles jederzeit löschen.',
  ...
  disclaimer_long: 'easli gibt nur allgemeine Informationen. easli ist keine Rechts-, Steuer-, Geld- oder Arzt-Beratung. Bei wichtigen Fragen fragen Sie bitte den Absender oder einen Fachmann (zum Beispiel: einen Arzt, einen Anwalt, eine Beratungsstelle).',
  copy: 'Kopieren',
  copied: 'Kopiert',
  ...
  privacy_intro: 'Ihr Vertrauen ist uns wichtig. So geht easli mit Ihren Daten um — klar und ehrlich.',
  ...
  scam_modal_subtitle: 'easli hat Warnsignale in diesem Brief gefunden. Bitte lesen Sie sorgfältig, bevor Sie etwas tun.',
