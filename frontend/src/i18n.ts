...
const en: UIStrings = {
  ...
  choose_language_subtitle: 'KlarPost will explain letters and documents in this language.',
  home_intro: 'Take a photo or upload a letter, and KlarPost will explain what it means and what you may need to do.',
  ...
  onb1_body: 'KlarPost reads your letters and documents and explains them in your language — calmly and clearly.',
...
const zh: UIStrings = {
  ...
  choose_language_subtitle: 'KlarPost 将用此语言为您解释信件和文件。',
  home_intro: '拍照或上传信件，KlarPost 会告诉您它的含义以及您可能需要做的事情。',
  scan_document: '扫描文件',
  ...
  onb1_title: '看懂信件',
  onb1_body: 'KlarPost 会读取您的信件和文件，并用您的语言冷静、清晰地解释它。',
...
const vi: UIStrings = {
  ...
  choose_language_subtitle: 'KlarPost sẽ giải thích thư và tài liệu bằng ngôn ngữ này.',
  home_intro: 'Chụp ảnh hoặc tải lên một bức thư, KlarPost sẽ giải thích nội dung và những việc bạn có thể cần làm.',
  ...
  onb1_body: 'KlarPost đọc thư và tài liệu của bạn và giải thích bằng ngôn ngữ của bạn — bình tĩnh và rõ ràng.',
...
const tr: UIStrings = {
  ...
  choose_language_subtitle: 'KlarPost mektup ve belgeleri bu dilde açıklayacak.',
  home_intro: 'Bir mektubun fotoğrafını çekin veya yükleyin; KlarPost size ne anlama geldiğini ve ne yapmanız gerekebileceğini anlatsın.',
  ...
  onb1_body: 'KlarPost mektup ve belgelerinizi okur ve sizin dilinizde sakin ve net şekilde açıklar.',
...
const ru: UIStrings = {
  ...
  choose_language_subtitle: 'KlarPost будет объяснять письма и документы на этом языке.',
  home_intro: 'Сфотографируйте или загрузите письмо, и KlarPost объяснит, что оно значит и что вам, возможно, нужно сделать.',
  ...
  onb1_body: 'KlarPost читает ваши письма и документы и объясняет их на вашем языке — спокойно и понятно.',
...
const es: UIStrings = {
  ...
  choose_language_subtitle: 'KlarPost te explicará las cartas y documentos en este idioma.',
  home_intro: 'Toma una foto o sube una carta y KlarPost te explicará lo que significa y lo que podrías necesitar hacer.',
  ...
  onb1_body: 'KlarPost lee tus cartas y documentos y los explica en tu idioma con calma y claridad.',
...
const de_simple: UIStrings = {
  ...
  onb1_body: 'KlarPost liest Briefe. KlarPost erklärt sie ruhig und klar.',
